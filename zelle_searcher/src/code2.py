...
class MoveBaseSeq():
    ...
    def __init__(self):
        ...
        self.g_add = 0
        self.goallist = [[0.81, 2.77], [-0.81, 6.63], [-3.06, 8.39], [-4.8, 6.5], [-3.0, 2.0], [-6.0, 3.7], [-6.0, 3.9], [-4.9, 5.9], [-4.3, 4.0], [-6.0, 3.8], [-4.2, 4.1], [-4.4, 4.6], [-4.2, -4.4], [-4.5, -4.6], [-4.6, 4.3], [-4.2, 0.7], [-3.1, -2.1], [-5.3, 0.78], [0.9, 3.5], [-4.6, 3.4], [-4.3, 6.0]]
