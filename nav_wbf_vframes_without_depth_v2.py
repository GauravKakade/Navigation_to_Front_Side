...
rospy.init_node('move_base_sequence2')
...
while True:
    ...
    frame_wbf = cv2.imdecode(message.image, 1)
    frame_id += 1
    ...
    cv2.putText(frame2, "FPS: " + str(round(fps, 2)), (10, 50), font, 2, (0, 0, 0), 3)
    ...
    if rgb_detection and depth_detection and Class_id_for_matching1 == Class_id_for_matching2:
        ...
        for box2 in boxes:
            ...
            cv2.rectangle(frame_wbf, ((int(boxes_wbm[0][0]*1000)), (int(boxes_wbm[0][1]*1000))), ((int(boxes_wbm[0][2]*1000)), (int(boxes_wbm[0][3]*1000))), color2, 2)
            cv2.imshow("Weighted Boxes Fusion", frame_wbf)
